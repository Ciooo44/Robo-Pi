...
const supportedHardware = [
  {
    name: "SO-100",
    status: "supported",
    description: "6-DOF robotic arm with gripper, leader/follower configuration",
  },
]
  ...
  return (
    <div className="font-mono">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">{"making sure that robotic ai is accessible to everyone"}</p>
      </div>
              ...
              {supportedHardware.map((robot, index) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground text-xs">{robot.description}</p>
                  </div>

                  {/* Sponsored By Section */}
                  <div className="flex flex-col items-end gap-2 ml-6">
                    <span className="text-xs text-muted-foreground uppercase tracking-wider">Sponsored by</span>
                    <a
            ...
            <div className="space-y-6">
              <div>
                <p className="text-muted-foreground mb-4">
                  Please provide us with access to different robot hardware, so we can add them to Robo-Pi. Reference:{" "}
                  <a
                ...
                <div className="bg-muted/60 dark:bg-black/40 border border-border dark:border-white/10 rounded-lg p-4 mb-4">
                  <h4 className="font-bold text-primary mb-2">How to contribute hardware support:</h4>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    onClick={() => window.open("mailto:tim@nerddisco.com?subject=Robo-Pi Hardware Support", "_blank")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => window.open("https://github.com/Ciooo44/Robo-Pi", "_blank")}
                  >
