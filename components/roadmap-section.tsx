...
const statusConfig = {
  ...
  planned: {
    ...
    bgColor: "bg-slate-500/10 dark:bg-slate-400/5",
      ...
      <div className="bg-gradient-to-br from-muted/60 to-muted/40 dark:from-black/40 dark:to-black/20 border border-primary/20 rounded-lg overflow-hidden">
        ...
        <div className="bg-primary/30 dark:bg-primary/10 border-b border-primary/20 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="text-foreground font-bold text-lg tracking-wider">SYSTEM OBJECTIVES</div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-500 dark:bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-green-700 dark:text-green-300 text-sm">{completedCount} ACTIVE</span>
                <div className="w-2 h-2 bg-slate-500 dark:bg-slate-400 rounded-full"></div>
                <span className="text-slate-700 dark:text-slate-300 text-sm">{totalCount - completedCount} QUEUED</span>
              </div>
            </div>
        ...
        <div className="bg-muted/50 dark:bg-black/30 border-t border-border dark:border-white/10 p-4">
          <p className="text-muted-foreground text-sm">
            ...
            (python-raspberry) and adapted for web robotic AI
          </p>
        </div>
      </div>
    </div>
