  ...
  return (
    <div className="font-mono">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">A quick guide to get started with the @robopi/web API.</p>
      </div>
      ...
      <div className="bg-muted/40 dark:bg-black/30 border-l-4 border-cyan-500 dark:border-accent-cyan p-6 md:p-8 rounded-r-lg space-y-8">
        ...
        <div>
          ...
          <CodeBlock>
            {`import { robopi } from '@robopi/web';

async function connectToRobot() {
  const { result } = await robopi.findPort({
  ...
  console.log('Found robots:', robots);
        ...
        <div>
          ...
          <div className="space-y-6 mt-4">
            {/* findPort */}
            <div>
              <h4 className="font-bold text-primary">robopi.findPort(options)</h4>
...
// Returns
{
  result: Promise<RobotConnection[]> // A promise that resolves with found robots
            ...
            {/* calibrate */}
            <div>
              <h4 className="font-bold text-primary">robopi.calibrate(robot, options)</h4>
...
// Returns
{
  ...
  stop: () => void // Function to stop the calibration recording
            ...
            {/* teleoperate */}
            <div>
              <h4 className="font-bold text-primary">robopi.teleoperate(robot, options)</h4>
